...
assert API_CONTRACT_LABEL == 'KYC_V3_property_usd_bank_commercial_tax', API_CONTRACT_LABEL
...
assert 'has_property_assets' in fields and 'has_usd_account' in fields, fields
print('OK: api container matches current KYC contract')
"
